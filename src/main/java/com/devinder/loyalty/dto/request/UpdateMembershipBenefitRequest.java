...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request body for updating a membership benefit")
public class UpdateMembershipBenefitRequest {
    ...
    @Schema(description = "Flag indicating whether this benefit is active", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
