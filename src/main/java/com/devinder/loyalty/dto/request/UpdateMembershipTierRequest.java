...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request body for updating a membership tier")
public class UpdateMembershipTierRequest {
    ...
    @Schema(description = "Flag indicating whether this tier is currently active", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
