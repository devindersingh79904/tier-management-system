...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request body for updating a membership plan")
public class UpdateMembershipPlanRequest {
    ...
    @Schema(description = "Flag indicating whether this plan is active", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
